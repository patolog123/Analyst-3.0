...
---
### ⚙️ Бизнес-правила
Оценки: Пользователь может оценить фильм только один раз
UNIQUE(user_id, movie_id)

Избранное: Фильм может быть в избранном один раз у пользователя
UNIQUE(user_id, movie_id)

Рекомендации: Максимум 5 рекомендаций за сессию
Check: position BETWEEN 1 AND 5

Локализация: Только фильмы с русской локализацией
WHERE is_russian = true

Новые пользователи: Ограниченный набор рекомендаций для новых пользователей
