...
|3	|   Агент запрашивает данные из API:	|   • NewsAPI (ключ: "emerging tech")
• Crunchbase (фильтр: 2023-2024)|
|4	|   Обработка данных:	|   • Ранжирование по частоте упоминаний
• Извлечение компаний через NER
• Фильтрация дублей|
